...
1. 训练神经网络常用算法：反向传播算法（[google提供的网页版直观说明其工作原理](https://google-developers.appspot.com/machine-learning/crash-course/backprop-scroll/)）
2. 反向传播算法训练失败：
...
3. 丢弃正则化：在梯度下降法的每一步随机丢弃一些网络单元，丢弃得越多，正则化效果就越强。
