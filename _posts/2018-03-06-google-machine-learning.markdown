...
9. 输入表示法（协同过滤，用户影片观看与否的矩阵）：
   ...
   - 字典表示，key是用户，value是看过的电影的编号。**稀疏张量**是分类数据的一种高效表示方法，但是对于大数据集不适用。
10. 例子：
   - 房屋售价的回归问题
   - 预测手写字的多类别分类
...
[![MlSystem.jpeg](https://i.loli.net/2019/04/11/5caf2c5f15f3b.jpeg)](https://i.loli.net/2019/04/11/5caf2c5f15f3b.jpeg)
